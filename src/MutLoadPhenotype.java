...
public class MutLoadPhenotype implements Phenotype {
	...
	public MutLoadPhenotype() {
        ...
        public MutLoadPhenotype(int load, boolean lethality, int type, int parentalDist) {
            mutLoad = load;
            lethal = lethality;
            antigenType = type;
	    ParentalDistance = parentalDist;
        }
	...
	public double distance(Phenotype p) {
		...
		//Phenotype mutP = new GeometricPhenotype(mutA,mutB);
                ...
                Phenotype mutP = new MutLoadPhenotype(newLoad, lethality, type, mutations);
		...
		String fullString = String.format("%d,%d", antigenType, mutLoad);
		return fullString;
	}
        ...
        public int ParentalDistance() {
		return ParentalDistance;
	}
}
