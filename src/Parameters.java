...
public class Parameters {
	...
	public static int thresholdMutationClade;
	public static int CladeSamples;
	public static boolean fitnessLogValue;
	...
	public static void load() {
		...
		try {
			...
			thresholdMutationClade = toInteger(map.get("thresholdMutationClade"));
			CladeSamples = toInteger(map.get("CladeSamples"));
			fitnessLogValue = toBoolean(map.get("fitnessLogValue"));
